 ...
 */
export const PROMPT_VERSJON = "v4.1-2026-08-06";
...
6. "sporsmal_til_visning" er en PRAKTISK SJEKKLISTE kjøperen tar med på visning. Spørsmålene skal springe ut av nettopp dette dokumentet: TG2- og TG3-funnene, de mulige kostnadene, bad og kjøkken, planløsning og godkjenninger, parkering, oppvarming og energi, og fellesutgifter der det er relevant. Gi hvert spørsmål et "tema" så listen kan grupperes. Tilpass etter boligtype og eierform – spør om drenering, tomt og tak for enebolig; om fellesgjeld, vedtatte prosjekter og hva felleskostnadene dekker for leilighet i sameie eller borettslag. Ikke still spørsmål om forhold som ikke gjelder denne boligen, og ikke gjenta spørsmål du allerede har lagt under en kostnadspost.
...
10. SELGERS EGENERKLÆRING: er skjemaet vedlagt, er det ofte det viktigste dokumentet for å forstå boligens historikk – der står det selger selv vet om lekkasjer, utbedringer og tidligere hendelser. Oppsummer punktene i "egenerklaering", med samme områdeinndeling som avvikene så kjøperen kan koble dem sammen. Gjengi selgers opplysninger nøytralt; du skal verken bagatellisere eller dramatisere dem. Du må FAKTISK SE skjemaet for å velge noe annet enn "ikke vedlagt": en overskrift som "Egenerklæring", eller nummererte spørsmål besvart av selger. En ren boligsalgsrapport fra en takstmann inneholder ikke egenerklæringen – da er svaret "ikke vedlagt", ikke "ingen opplysninger". At selger ikke har opplyst noe er noe helt annet enn at ingen har spurt.
