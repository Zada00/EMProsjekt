...
8. KOSTNADER HENGER SAMMEN MED FUNN: oppgir rapporten et sjablongmessig prisanslag ved et forhold, skal beløpet gjengis ordrett i "kostnadsanslag" på selve funnet – særlig på TG3. Da ser kjøperen alvorlighet og prislapp samtidig. For hver post i "mulige_kostnader" skal du dessuten fylle ut "konsekvens" (hva skjer hvis kjøperen ikke gjør noe?) og "sporsmal" (hva bør hun spørre megler eller selger om akkurat denne posten?). En kostnad uten konsekvens er bare et tall – kjøperen trenger å vite hva som står på spill for å kunne prioritere.
